...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_page(array(
        ...
        'menu_title'    => 'Doddiscombsleigh',
        'menu_slug'     => 'theme-general-settings', //always the same as 'parent_slug'
        'position'      => 2,
    ...
    acf_add_options_sub_page(array(
        ...
        'parent_slug'   => 'theme-general-settings' //always the same as 'menu_slug'
    ));

		acf_add_options_sub_page(array(
				'page_title'    => 'Global Images',
				'menu_title'    => 'Global Images',
				'parent_slug'   => 'theme-general-settings' //always the same as 'menu_slug'
		));
